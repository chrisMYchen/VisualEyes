...
class DB {
  // initial connection
  public static $dbName = 'fitnessvalues';
  public static $user = 'ThunderPunch';
  public static $password = 'Power75';
...
class MeekroDB {
  // initial connection
  public $dbName = 'fitnessvalues';
  public $user = 'ThunderPunch';
  public $password = 'Power75';
